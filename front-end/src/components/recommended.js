...
const Recommended = () => {
    ...
    let charity1 = new Charity("Orangutan Foundation", "orangutan conservation project", 4, "https://www.orangutan.org.au/static/media/uploads/adoption/mary_adoption727x727.jpg")
