...
const Recommended = async () => {
    ...
    let charity1 = new Charity(data[0].charityName, data[0].cause.causeName, data[0].currentRating.rating);
    let charity2 = new Charity(data[1].charityName, data[1].cause.causeName, data[1].currentRating.rating);
    let charity3 = new Charity(data[2].charityName, data[2].cause.causeName, data[2].currentRating.rating);
    let charity4 = new Charity(data[3].charityName, data[3].cause.causeName, data[3].currentRating.rating);
    let charity5 = new Charity(data[4].charityName, data[4].cause.causeName, data[4].currentRating.rating);
    let charity6 = new Charity(data[5].charityName, data[5].cause.causeName, data[5].currentRating.rating);
    let charity7 = new Charity(data[6].charityName, data[6].cause.causeName, data[6].currentRating.rating);
    let charity8 = new Charity(data[7].charityName, data[7].cause.causeName, data[7].currentRating.rating);
    console.log(charity3.cause)
    return (
