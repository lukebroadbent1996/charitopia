...
const Recommended = () => {
    ...
    // Kim!!! Use TERNARY OPERATORS!!! eg. isAuth ? <code if fetched data exists> : <code if it doesn't exist yet>.  This is very much necessary with handlefetch!!!
